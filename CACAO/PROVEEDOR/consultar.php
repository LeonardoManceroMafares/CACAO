...
<h1  style="background: white; width: 50%;">MODIFICAR Y ELIMINAR INFORMACION</h1>
				...
				<td>ELIMINAR</td>
					...
					<td><a href="modificar.php?idproveedor=<?php echo $resultados['idproveedor']; ?>">MODIFICAR</a></td>
					<td><a href="eliminar.php?idproveedor=<?php echo $resultados['idproveedor']; ?>">ELIMINAR</a></td>
					</tr>
