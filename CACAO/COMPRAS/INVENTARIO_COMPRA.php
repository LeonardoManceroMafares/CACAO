...
$pdf->Cell(20, 8, 'IDITEM', 0);
$pdf->Cell(45, 8, 'PROVEEDOR', 0);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$productos = mysql_query("select idcompra,b.idproveedor,c.iditem,nombre_proveedor,fecha,a.cantidad,valor,total,cancelado,c.stock from compras a,proveedor b,items c where b.idproveedor=a.idproveedor and c.iditem = a.iditem order by idcompra asc");

while($productos2 = mysql_fetch_array($productos)){
	$pdf->Cell(15, 8, '', 0);
	$pdf->Cell(25, 8,$productos2['idcompra'], 0);
	$pdf->Cell(20, 8,$productos2['iditem'], 0);
	$pdf->Cell(40, 8, $productos2['nombre_proveedor'], 0);
