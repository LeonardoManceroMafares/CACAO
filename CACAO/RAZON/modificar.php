...
<body background="../css/images/1.jpg">
		...
		require '../conexion.php';
										...
										$consultar="SELECT * FROM razon WHERE idrazon='$idrazon'";
										$resultado=$conexion->query($consultar);
										$resultados=$resultado->fetch_array();
										
								?>
			<div  style="width: 70%; padding-left: 17%;" >				
			<form action="modificar_razon.php?idrazon=<?php echo $resultados['idrazon']; ?>" method="post">
			              
			                 
			<br><br><br><br>
						<div align="center" style="background: #58ACFA;"><br><br>
						<input style="font-family: fantasy;font-size: 20px" type="text" placeholder="NOMBRE" required="required" name="nombre_razon" value="<?php echo $resultados['nombre_razon']; ?>"><br><br>
						...
						<input style="font-family: fantasy;font-size: 20px" type="text" placeholder="RUC" required="required" name="ruc" value="<?php echo $resultados['ruc']; ?>"><br><br>
