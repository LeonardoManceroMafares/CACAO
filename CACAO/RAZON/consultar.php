				...
				<td>ELIMINAR</td>
							...
							while ($resultados=$resultado->fetch_assoc()){
								?>
									...
									<td><?php echo$resultados['ruc'] ?></td>
									
					<td><a href="modificar.php?idrazon=<?php echo $resultados['idrazon']; ?>">MODIFICAR</a></td>
					<td><a href="eliminar.php?idrazon=<?php echo $resultados['idrazon']; ?>">ELIMINAR</a></td>
					</tr>
