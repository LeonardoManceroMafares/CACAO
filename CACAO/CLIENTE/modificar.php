...
<body background="../css/images/1.jpg">
		...
		require '../conexion.php';		
										...
										$consultar="SELECT * FROM cliente WHERE idcliente='$idcliente'";
										$resultado=$conexion->query($consultar);
										$resultados=$resultado->fetch_array();
										
								?>
			<div  style="width: 70%; padding-left: 17%;" >				
			<form action="modificar_cliente.php?idcliente=<?php echo $resultados['idcliente']; ?>" method="post">
			              
			                 
			<br><br><br><br>
						<div align="center" style="background: #58ACFA;"><br><br>
						<input style="font-family: fantasy;font-size: 20px" type="text" placeholder="NOMBRE" required="required" name="nombre_cliente" value="<?php echo $resultados['nombre_cliente']; ?>"><br><br>
